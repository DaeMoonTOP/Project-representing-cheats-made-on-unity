...
public class SC_FPSController : MonoBehaviour
{
    ...
    public bool OgranSpeed = true;
    public bool offRest = true;
    ...
    void Update()
    {
        ...
        if (OgranSpeed == true)
        {
            if (walkingSpeed > 50f) walkingSpeed = 50f;
        }
        if (OgranSpeed == false)
        {
            if (walkingSpeed > 100f) walkingSpeed = 100f;
        }
        ...
        if (offRest == true)
        {
            if (!Input.GetButton("Jump") && canMove && characterController.isGrounded) walkingSpeed = 7.5f;
        }
